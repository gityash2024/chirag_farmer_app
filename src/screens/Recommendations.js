...
const Recommendations = () => {
  ...
  const renderRecommendations = () => (
    ...
    >
      <ScrollView>
        <Text style={styles.recommendationTitle}>Recommendation for "{selectedCrop}"</Text>
        <Text style={styles.instructionText}>Please read the Recommendation carefully!</Text>
        ...
        <View style={styles.checkboxContainer}>
          ...
          />
          <Text style={styles.checkboxLabel}>I have read all the recommendations carefully.</Text>
        </View>
        <TouchableOpacity
