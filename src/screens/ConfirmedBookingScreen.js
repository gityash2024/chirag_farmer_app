  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.statusContainer}>
        ...
        <Text style={[styles.statusText, typography['sans-bold']]}>Booking confirmed</Text>
      </View>
      ...
      <View style={styles.quoteCard}>
        <Text style={[styles.quoteTitle, typography['sans-bold']]}>Quote</Text>
        <Text style={[styles.estimatedTotal, typography['sans-medium']]}>Estimated Total : ₹2589</Text>
        ...
        <View style={styles.paymentRow}>
          ...
          <Text style={[styles.paymentAmount, typography['sans-regular']]}>₹1999</Text>
        </View>
        <View style={styles.paymentRow}>
          <Text style={[styles.paymentLabel, typography['sans-regular']]}>Taxes and fee</Text>
          <Text style={[styles.paymentAmount, typography['sans-regular']]}>₹199</Text>
        </View>
        <View style={styles.separator} />
        <View style={styles.paymentRow}>
          <Text style={[styles.totalLabel, typography['sans-bold']]}>Total</Text>
          <Text style={[styles.totalAmount, typography['sans-bold']]}>₹2198</Text>
        </View>
      </View>
    </ScrollView>
  );
