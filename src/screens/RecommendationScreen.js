    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>
          Recommendation for "{booking.cropName}"
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.dangerText}>
          Do not operate if visibility during Fog/mist is not good
        </Text>
      </View>
      <View style={styles.divider} />
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          <Text style={styles.label}>
            Plain land: take care of obstacles present in field :
          </Text>
          <Text style={styles.value}>Yes</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.label}>
            Sloppy terrain: Use terrain following sensors:
          </Text>
          <Text style={styles.value}>Yes</Text>
        </View>
      </View>
      <View style={styles.section}>
        ...
        <Text style={styles.dangerText}>
          ...
          to be used in entire crop duration. Same chemical should not be chosen
          for second spray. Sprays should always be directed towards whorl and
          applied either in early hours of the day or in the evening time.
        </Text>
      </View>
