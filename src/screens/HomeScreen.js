...
const HomeScreen = () => {
  ...
  const [playing, setPlaying] = useState(Array(3).fill(false));
  ...
  const fetchBookings = async () => {
    try {
      ...
      let filteredBookings = response.filter((booking) =>
        ["requested", "quote_received", "confirmed"].includes(booking.status)
      );
      filteredBookings = filteredBookings?.filter(
        (booking) => booking?.runner?._id === _id
      );
  ...
  const indianLocations = [
    { latitude: 28.6139, longitude: 77.209, name: "New Delhi" },
    { latitude: 19.076, longitude: 72.8777, name: "Mumbai" },
  ...
  const testimonials = [
    {
      id: 1,
      image: require("../../assets/client-1-logo.png"),
      name: "Courtney Henry",
      videoId: "dQw4w9WgXcQ",
    },
    {
      id: 2,
      image: require("../../assets/client-2-logo.png"),
      name: "John Doe",
      videoId: "M7lc1UVf-VE",
    },
    {
      id: 3,
      image: require("../../assets/client-3-logo.png"),
      name: "Jane Smith",
      videoId: "Ks-_Mh1QhMc",
    },
  ];
  ...
  const clients = [
    require("../../assets/client-1-logo.png"),
    require("../../assets/client-2-logo.png"),
    require("../../assets/client-3-logo.png"),
    require("../../assets/client-4-logo.png"),
    require("../../assets/client-5-logo.png"),
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
          ...
          {bookings.map((booking) => (
            <View key={booking._id} style={styles.bookingCard}>
              ...
              <View style={styles.locationContainer}>
                ...
                />
                <Text style={styles.address}>{booking.farmLocation}</Text>
              </View>
        ...
        <Image
          source={require("../../assets/drone-image.png")}
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statItem}>
            <Image
              source={require("../../assets/states-icon.png")}
          ...
          <View style={styles.statItem}>
            <Image
              source={require("../../assets/drones-icon.png")}
              style={styles.statIcon}
            />
          ...
          <View style={styles.statItem}>
            <Image
              source={require("../../assets/pilots-icon.png")}
              style={styles.statIcon}
            />
          ...
          <View style={styles.statItem}>
            <Image
              source={require("../../assets/acres-icon.png")}
              style={styles.statIcon}
            />
          ...
          <View style={styles.statItem}>
            <Image
              source={require("../../assets/farmers-icon.png")}
              style={styles.statIcon}
            />
        ...
        <View style={styles.farmingServicesContainer}>
          ...
          <View style={styles.serviceCard}>
            <View style={styles.serviceCardContent}>
              ...
              <Text style={styles.serviceCardDescription}>
                ...
                issues or questions you may have while in the field.
              </Text>
            </View>
            <Image
              source={require("../../assets/drone-service-image.png")}
              style={styles.serviceCardImage}
            />
          </View>
          <View style={styles.serviceCard}>
            <Image
              source={require("../../assets/easy-reservation-image.png")}
              style={styles.serviceCardImage}
            />
            <View style={styles.serviceCardContent}>
              <Text style={styles.serviceCardTitle}>Data Security</Text>
              <Text style={styles.serviceCardDescription}>
                We prioritize your privacy by using advanced encryption and
          ...
          <View style={[styles.serviceCard, styles.serviceCardReverse]}>
            <Image
              source={require("../../assets/reliable-service-image.png")}
              style={styles.serviceCardImage}
            />
            <View style={styles.serviceCardContent}>
              <Text style={styles.serviceCardTitle}>Certified Training</Text>
              <Text style={styles.serviceCardDescription}>
                All our runners receive comprehensive training and
                certification, ensuring they have the necessary skills and
                knowledge for effective and safe drone operations.
              </Text>
            </View>
          </View>
        </View>
        ...
        <Image
          source={require("../../assets/client_drown.png")}
          style={styles.client_drown}
        />
        <ScrollView
          horizontal
        ...
        >
          {[...Array(3)].map((_, outerIndex) => (
            <View key={outerIndex} style={styles.clientPage}>
              {clients.map((client, index) => (
                <View key={index} style={styles.clientLogo}>
                  <Image source={client} style={styles.clientLogoImage} />
                </View>
              ))}
            </View>
          ))}
